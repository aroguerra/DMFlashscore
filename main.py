...
def main():
    ...
    # parser.add_argument("matches", help="number2 to calculate")
    # parser.add_argument("players", help="number2 to calculate")
    # parser.add_argument("form5", help="number2 to calculate")
    # parser.add_argument("teams", help="number2 to calculate")
